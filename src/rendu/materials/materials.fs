...
// Paramètres du matériau (venant de tiny_gltf via Uniforms)
...
void main() {
    ...
    vec3 V = normalize(u_CameraPos - vPosition);
    vec3 L = normalize(u_LightPos - vPosition);
    ...
    // Tonemapping simple et correction gamma
